...
public class BDOrderAchievementServiceImpl {
    ...
    public static String excall(long uid, List<BDCompVO> compList, List<BDToOrderAchieveemntVO> oList, HashMap<String,String> bdsum, HashMap<String,String> bdNewAddSum ) {
