 ...
 */
 ...
 /**已抢单成功 可以获取待取货列表  , 成功取货后改变状态为 已取货*/
 const int sGRAB = 7;
...
/****************************************************** 订 单 数 据 模 块  *************************************************************/
 ...
 /** 订单数据简略模型*/
    struct OrderBrief{
        ...
        string time;//取货时间 或者 到货时间  例如: 2018/07/05 13:00-18:00 取货  或  2018-07-05到货
    ...
    struct OrderComplex{
        ...
        string feeInfo;//费用信息		 无代收,无报价,线下支付3000元整单
        string pickTime;//取货时间		 2018-11-11 13:00-16:00取货
        string contactInfo;//联系方式    15608447849,13873140557
        string takeInfo;//收货人相关信息 李世平,送货不上楼,原件返回
        string arrivalTime;//到货时间    2018/11/10 - 2018/11/11 
        ...
        bool isOnline;//是否线上支付 /线下支付,不用进行金额确认
        bool isPay;//是否付款成功
...
/****************************************************** 请实现以下接口 *************************************************************/
	 ...
	 interface DriverService{
        ...
        */
         ...
         *  enterpriseid 企业码
         *  state 查询的状态值
         *  year 查询年份 index 页码 range 每页多少条
        ...
        */
         ...
         * 一块医药更新订单状态
         */
         bool updateOrderStateYKYY(int userid,int compid,long orderNo,int state);
     };
