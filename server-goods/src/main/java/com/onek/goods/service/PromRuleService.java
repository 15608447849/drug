...
public class PromRuleService {
    ...
    private static final String QUERY_ALL_PROD_BRULE = "select brulecode from {{?" + DSMConst.TD_PROM_ACT +"}} a, {{?"+ DSMConst.TD_PROM_ASSDRUG +"}} d where a.unqid = d.actcode and d.cstatus&1 = 0 and a.cstatus&1 = 0 and a.cstatus&2048>0 and act.cstatus&32 = 0 " +
    ...
    private static final String QUERY_CLASS_PROD_BRULE  = "select brulecode,d.gcode from " +
            ...
            "and d.cstatus &1 =0  and a.cstatus &1 =0 and a.cstatus&2048>0 and act.cstatus&32 = 0 " +
    ...
    public static final String QUERY_PRECISE_PROD_BRULE =
            ...
            "and d.cstatus &1 =0 and a.cstatus &1 =0 and a.cstatus&2048>0 and act.cstatus&32 = 0   and length(d.gcode) >= 14 and a.sdate <= CURRENT_DATE and CURRENT_DATE<= a.edate " +
