...
public class FileInfoModule {
    ...
    private void publicConfig(HashMap<String, Object> map) {
        ...
        map.put("homeFilePath",defaultHome());//资源主目录-轮播图等存放
        map.put("noticeFilePath",defaultNotice());//公告目录
    }
    //特有
    private void specificConfig(QueryParam queryParam, HashMap<String, Object> map) {
