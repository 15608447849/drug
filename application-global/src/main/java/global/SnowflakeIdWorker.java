...
public class SnowflakeIdWorker {
    ...
    /** 开始时间截 (2019-03-28) */
    private final long twepoch = 1553775422381L;

    /** 机器id所占的位数(负载均衡子服务最多7个) */
    private final long workerIdBits = 3L;

    /** 数据标识id所占的位数（服务节点最多511个） */
    ...
    /** 工作机器ID(0~7)  负载均衡子服务最多7个*/
    private long workerId;

    /** 数据中心ID(0~511) （服务节点最多511个）*/
    ...
    public synchronized long nextId() {
        System.out.println(getDatacenterId()+"  "+getWorkerId());
